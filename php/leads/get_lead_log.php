...
if ($stmt = $con->prepare( 'SELECT Temp.*, accounts.username
                            From (SELECT C.cid, C.name, C.city, C.address, C.email, C.phone, C.source, C.l_status, CL.clid, CL.entry_type, CL.entry_date, CL.entry_description, CL.account_id, CL.entry_title, CL.file_exe, CL.file_path
