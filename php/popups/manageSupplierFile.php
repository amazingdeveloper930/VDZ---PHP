...
<form id="supplierfilelog" class="col s12">
  ...
  <div class="bottombuttons">
	<span class="button waves-effect waves-light btn full" onclick="saveSupplierFile()"><i class="material-icons">add</i> Bestand toevoegen</span>
  </div>
