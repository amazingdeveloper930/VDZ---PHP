...
<form id="employeefilelog" class="col s12">
  ...
  <div class="bottombuttons">
	<span class="button waves-effect waves-light btn full" onclick="saveEmployeeFile()"><i class="material-icons">add</i> Bestand toevoegen</span>
  </div>
