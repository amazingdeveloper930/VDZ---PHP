...
function updateTimerWiget(contactid)
{
    $.ajax({
        type: "POST",
        url: "../php/productie/get_project.php",
        data: {
            contactid: contactid
        },
        dataType: "json",
        success: function(result) {
            if(result.length > 0){
                ...
                var timer_widget = result.timer_1;
                if(result.m_status2 == 'NO')
                    timer_widget = result.timer_2;
                else if(result.m_status3 == 'NO')
                    timer_widget = result.timer_3;
                ...
                if(result.m_status1 == 'YES')
                {
                    var btn_restart = '<div class="actiebutton btn-refresh" onclick="restartProject(' + contactid + ', \'MODE1\')"><i class="material-icons">refresh</i></div>';
                    result.timer_1 += btn_restart;
                }
                else
                {
                    var btn_done = '<span class="button btn btn-complete" onclick="completeProject(' + contactid + ', \'MODE1\')"><i class="material-icons">done</i> Ja</span>';
                    result.timer_1 += btn_done;
                }

                if(result.m_status2 == 'YES')
                {
                    var btn_restart = '<div class="actiebutton btn-refresh" onclick="restartProject(' + contactid + ', \'MODE2\')"><i class="material-icons">refresh</i></div>';
                    result.timer_2 += btn_restart;
                }
                else
                {
                    var btn_done = '<span class="button btn btn-complete" onclick="completeProject(' + contactid + ', \'MODE2\')"><i class="material-icons">done</i> Ja</span>';
                    result.timer_2 += btn_done;
                }

                if(result.m_status3 == 'YES')
                {
                    var btn_restart = '<div class="actiebutton btn-refresh" onclick="restartProject(' + contactid + ', \'MODE3\')"><i class="material-icons">refresh</i></div>';
                    result.timer_3 += btn_restart;
                }
                else
                {
                    var btn_done = '<span class="button btn btn-complete" onclick="completeProject(' + contactid + ', \'MODE3\')"><i class="material-icons">done</i> Ja</span>';
                    result.timer_3 += btn_done;
                }


                $(".contacten-table tr[contactrow=" + contactid + "] td:nth-child(6)").html(result.timer_1);
                $(".contacten-table tr[contactrow=" + contactid + "] td:nth-child(7)").html(result.timer_2);
                $(".contacten-table tr[contactrow=" + contactid + "] td:nth-child(8)").html(result.timer_3);
            }
        },
...
function completeProject(contact_id, mode = 'MODE1')
{
    var data = {
    ...
    $.ajax({
        type: "POST",
        url: "../php/productie/complete_project.php",
        data: data,
        dataType: "json",
        success: function(result) {
...
function restartProject(contact_id, mode = 'MODE1')
{
    var data = {
        contact_id: contact_id,
        mode: mode
    ...
    $.ajax({
        type: "POST",
        url: "../php/productie/restart_project.php",
        data: data,
        dataType: "json",
        success: function(result) {
